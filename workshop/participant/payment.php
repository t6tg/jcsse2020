...
<?php 
        ...
        if($r_n != "" && $r_a != ""){
        $sql_receipt = "UPDATE workshop_general_ticket SET receipt_name='$r_n' , receipt_address='$r_a' WHERE unique_code='$id'";
    ...
    if($charge['status'] == 'successful'){
        ...
        $sql_paid = "UPDATE workshop_general_ticket SET pay_st='0' WHERE unique_code='$id'";
        mysqli_query($conn,$sql_paid);
    }
    mysqli_close($conn);
?>