...
$sql_parti = $conn->query("SELECT * FROM general_ticket WHERE pay_st='-1'");
$sql_author = $conn->query("SELECT * FROM author WHERE pay_st='-1'");
$sql_workshop_patri = $conn->query("SELECT * FROM workshop_general_ticket WHERE pay_st='-1'");
$sql_workshop_author = $conn->query("SELECT * FROM workshop_author WHERE pay_st='-1'");
    ...
    <div class="content-wrapper">
        <div class="container"><br><br>
            <?php if ($_GET['menu'] == "participant") { ?>
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Transfer Validate</h3>
                    </div>
                    <!-- /.box-header -->
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img style="width: 100%" src="<?php echo "../../regis/participant/slip_transfer_bank/" . $row_parti['unique_code'] . ".jpg"; ?>" alt="transfer-slip">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal fade" id="<?php echo $row_author['username']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img style="width: 100%" src="<?php echo "../../regis/portal/main/slip_transfer_bank/" . $row_author['username'] . ".jpg"; ?>" alt="transfer-slip">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <?php } else if ($_GET['menu'] == "wsparticipant") { ?>
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Transfer Validate ( Participant Workshop )</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body no-padding">
                        <table class="table table-condensed">
                            <tbody>
                                ...
                                <?php while ($row_workshop_parti = $sql_workshop_patri->fetch_array()) { ?>
                                    <tr>
                                        <td>1.</td>
                                            ...
                                            <div class="modal fade" id="<?php echo $row_workshop_parti['unique_code']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img style="width: 100%" src="<?php echo "../../workshop/participant/slip_transfer_bank/" . $row_workshop_parti['unique_code'] . ".jpg"; ?>" alt="transfer-slip">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <?php } else if ($_GET['menu'] == "wsauthor") { ?>
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Transfer Validate ( Author Workshop )</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body no-padding">
                        <table class="table table-condensed">
                            <tbody>
                                ...
                                <?php while ($row_workshop_author = $sql_workshop_author->fetch_array()) { ?>
                                    <tr>
                                        ...
                                        <td><button name="" id="" class="btn btn-danger" onclick="confirm_nopass('wsauthor','<?php echo $row_author['username']; ?>')" role="button"><i class="fa fa-close" aria-hidden="true"></i></button></td>
                                        <td>
                                            ...
                                            <div class="modal fade" id="<?php echo $row_workshop_author['username']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img style="width: 100%" src="<?php echo "../../workshop/portal/main/slip_transfer_bank/" . $row_workshop_author['username'] . ".jpg"; ?>" alt="transfer-slip">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function confirm_pass(name, value) {
            if (confirm("Are you sure you want to update this..?") === true) {
                window.location.href = "payvali.php?menu=" + name + "&status=pass&id=" + value
                return true;
            } else {
                return false;
            }
        ...
        function confirm_nopass(name, value) {
            if (confirm("Are you sure you want to update this..?") === true) {
                window.location.href = "payvali.php?menu=" + name + "&status=nopass&id=" + value
                return true;
            } else {
                return false;
            }
...
if ($_GET['menu'] == "participant") {
    if ($_GET['status'] == "pass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE general_ticket SET pay_st='1' WHERE unique_code='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-pass','participant')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=participant';</script>";
    } else if ($_GET['status'] == "nopass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE general_ticket SET pay_st='0' WHERE unique_code='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-nopass','participant')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=participant';</script>";
    }
}
if ($_GET['menu'] == "wsparticipant") {
    if ($_GET['status'] == "pass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE workshop_general_ticket SET pay_st='1' WHERE unique_code='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-pass','workshop-participant')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=wsparticipant';</script>";
    } else if ($_GET['status'] == "nopass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE workshop_general_ticket SET pay_st='0' WHERE unique_code='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-nopass','workshop-participant')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=wsparticipant';</script>";
    }
}
if ($_GET['menu'] == "author") {
    if ($_GET['status'] == "pass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE author SET pay_st='1' WHERE username='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-pass','author')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=author';</script>";
    } else if ($_GET['status'] == "nopass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE author SET pay_st='0' WHERE username='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-nopass','author')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=author';</script>";
    }
}
if ($_GET['menu'] == "wsauthor") {
    if ($_GET['status'] == "pass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE workshop_author SET pay_st='1' WHERE username='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-pass','workshop-author')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=wsauthor';</script>";
    } else if ($_GET['status'] == "nopass" && $_GET['id'] != "") {
        $id = $_GET['id'];
        $sql_update_par = "UPDATE workshop_author SET pay_st='0' WHERE username='$id'";
        $conn->query($sql_update_par);
        $sql_log = "INSERT INTO logfile (name,manage,type) VALUES('$id','pay-nopass','workshop-author')";
        $conn->query($sql_log);
        echo "<script>window.location.href='payvali.php?menu=wsauthor';</script>";
    }
}
