...
$sql_log = $conn->query("SELECT * FROM logfile ORDER BY id DESC");
?>
<!DOCTYPE html>
<html>
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-condensed">
                            <tbody>
                                <tr>
                                    <th>ID or Username</th>
                                    <th>Manage</th>
                                    <th>Type</th>
                                    <th>Time</th>
                                </tr>
                                <?php while ($row_log = $sql_log->fetch_array()) {?>
                                <tr>
                                    <td><?php echo $row_log['name']; ?></td>
                                    <td><?php echo $row_log['manage']; ?></td>
                                    <td><?php echo $row_log['type']; ?></td>
                                    <td><?php echo $row_log['time_stamp']; ?></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
