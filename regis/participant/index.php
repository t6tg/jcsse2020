            ...
            <center>
                <form class="form-regis" name="myForm" id="signup-form" enctype="multipart/form-data" action="insert.php" method="post">
                    <div lass="form-group">
                        ...
                        <input type="text" class="form-control" name="fname" id="" aria-describedby="helpId" placeholder="First name">
                        <!-- lastname --><br>
                        <label><b>Last Name <span style="color:red">*</span></b></label>
                        <input type="text" class="form-control" name="lname" id="" aria-describedby="helpId" placeholder="Last name">
                        <!-- Badge --><br>
                        <label><b>Name on Badge (it will appear on your name tag) <span style="color:red">*</span></b></label>
                        <input type="text" class="form-control" name="badge" id="" aria-describedby="helpId" placeholder="Name on Badge">
                        <!-- Affiliation --><br>
                        <label><b>Affiliation <span style="color:red">*</span></b></label>
                        <input type="text" class="form-control" name="affiliation" id="affiliation" aria-describedby="helpId" placeholder="Affiliation">
                    </div>
                    <!-- country --><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group" id="ieee-div" style="border:1px solid;border-radius:10px;padding:20px;display:none;margin-top:10px">
                            <label for=""><b>IEEE Member File <span style="color:red">*</span></b></label>
                            <input type="file" class="form-control-file" name="ieeefile" id="ieee-file" placeholder="" aria-describedby="fileHelpId">
                            <br>
                        </div>
                    </div>
                    <div class="price">
