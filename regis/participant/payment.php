    ...
    <div class="container">
        <center>
            <div class="card-regis" style="margin-bottom: 40px;"><br>
                ...
                <div>
                    <input type="text" style="padding:10px;width:60%;background-color: #eee;border:none;color:#333;" value="<?php echo "https://jcsse2020.cs.kmutnb.ac.th/regis/participant/payment.php?id=", $id; ?>" id="myInput" readonly />
                    <button style="padding:10px;width:10%;color:#fff;background-color:#777" onclick="myFunction()"><i class="fa fa-clipboard"></i></button></div><br>
                <table style="width: 70%" class="table table-striped table-inverse">
                    ...
                    <tbody>
                        <tr>
                            <td scope="row">1</td>
                            <td><?php if ($row['participant_st'] == '1') {
                                    echo "IEEE Member";
                                } else if ($row['participant_st'] == '0') {
                                    echo "Non-IEEE Member/Accompanying person/Student";
                                } else if ($row['participant_st'] == '2') {
                                    echo "JCSSE Committee/ JCSSE Reviewer";
                                } else if ($row['participant_st'] == '3') {
                    ...
                    <?php if ($row['pay_st'] == "" || $row['pay_st'] == "0") { ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form id="checkoutForm" method="POST" action="">
                                    <script type="text/javascript" src="https://cdn.omise.co/omise.js" data-key="pkey_test_5hf4ps01m8g5qxyrzw7" data-amount="<?php echo $row['price'] * 100; ?>" data-frame-label="KMUTNB" data-image="https://www.pnglot.com/pngfile/detail/119-1193996_download-rubber-duck-png-clipart-rubber-duck-clip.png" data-frame-description="king mongkut's university of technology north bangkok" data-submit-label="Checkout" data-currency="THB" data-button-label="Click To Pay" data-default-payment-method="credit_card">
                                        < input type = "hidden"
                                        name = "id"
                        ...
                        <div class="row">
                            <div<br class="col-md-12">
                                ...
                                <?php if ($row['participant_st'] == '1' && $row['ieee_ch'] == '1') {
                                    echo "<br><div class='status-success'>IEEE : SUCCESSFUL</div>";
                                } else if ($row['participant_st'] == '1' && $row['ieee_ch'] == '0') {
                                    echo "<br><div class='status-success' style='background-color:orange'>IEEE : Awaiting review </div>";
                                } else if ($row['participant_st'] == '1' && $row['ieee_ch'] == '-1') {
                                    echo "<br><div class='status-fail'>IEEE : FAIL </div>";
                                } ?><br>
                                <?php if ($row['receipt_name'] == "") { ?>
                                    <form action="" style="width:70%" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="receipt_name" id="" class="form-control" placeholder="Receipt Name" aria-describedby="helpId">
                                            <br>
                                            <label style="float:left"><b>Receipt Addrees <span style="color:red;">*</span></b></label>
                                            <div class="form-group">
                                ...
                                <?php } else {  ?>
                                    <form action="" style="width:70%" method="post">
                                        <div class="form-group">
                                            <label style="float:left"><b>Receipt Name <span style="color:red;">*</span></b></label>
                                            <input type="text" id="" class="form-control" value="<?php echo $row['receipt_name'] ?>" disabled>
                                            <br>
                                            <label style="float:left"><b>Receipt Addrees <span style="color:red;">*</span></b></label>
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="<?php echo $row['receipt_address']; ?>" id="" rows="3" disabled></textarea>
                                            </div>
                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
